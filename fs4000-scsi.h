...
int fs4000_set_window(UINT2 x_res, UINT2 y_res, UINT4 x_upper_left, UINT4 y_upper_left, UINT4 width, UINT4 height, BYTE bits_per_pixel);
...
void    print_fs4000_get_thumbnail_window (
                                FS4000_GET_WINDOW_FOR_THUMBNAIL_CDB *cdb,
                                FS4000_GET_WINDOW_DATA_IN *data);

int     fs4000_get_thumbnail_window (
                                UINT2 *x_res,
                                UINT2 *y_res,
                                UINT4 *x_upper_left,
                                UINT4 *y_upper_left,
...
extern
int     (*fs4000_do_scsi)       (void           *cdb,
                                 unsigned int   cdb_length,
                                 int            data_dir,
                                 void           *data_buf,
                                 unsigned int   data_buf_len);

int     fs4000_get_film_status_rec (
                                FS4000_GET_FILM_STATUS_DATA_IN_28 *data);

int     fs4000_get_lamp_rec     (FS4000_GET_LAMP_DATA_IN *data);

int     fs4000_get_scan_mode_rec (FS4000_GET_SCAN_MODE_DATA_IN_38 *data);

int     fs4000_put_scan_mode_rec (FS4000_DEFINE_SCAN_MODE_DATA_OUT *param);

int     fs4000_get_window_rec   (FS4000_GET_WINDOW_DATA_IN *data);

int     fs4000_put_window_rec   (FS4000_SET_WINDOW_DATA_OUT *param);
